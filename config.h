...
static const char *const autostart[] = {
	...
	"sh", "-c", "feh --randomize --bg-fill ~/Midia/Imagens/Wallpapers/*", NULL,
	"picom", "-b", NULL,
	"flameshot", NULL,
	"dunst", NULL,
	"slstatus", NULL,
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_p,          spawn,            SHCMD ("flameshot full -p ~/Midia/Imagens/Screenshots") },
	{ MODKEY|ShiftMask,             XK_p,          spawn,            SHCMD ("flameshot gui -p ~/Midia/Imagens/Screenshots") },
	{ MODKEY|ControlMask,           XK_p,          spawn,            SHCMD ("flameshot gui --clipboard") },
	{ MODKEY|ShiftMask,             XK_w,          spawn,            SHCMD ("feh --randomize --bg-fill ~/Midia/Imagens/Wallpapers/*") },
